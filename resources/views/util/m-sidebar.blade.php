<div class="col-lg-3">
	<div class="btn-group-vertical col-lg-12" style="width: 100%;" role="group">
		...
		<a href="{{ route('all_assoc') }}" class="btn btn-default text-left size-13 col-lg-12" role="button"><span class="glyphicon glyphicon-flag"></span> Device Log<span class="badge right">{{ App\DeviceLog::getCountDeviceLog() }}</span></a>
...
<a href="" class="btn btn-default text-left col-lg-12" role="button" data-popover="true" tabindex="1" data-html="true" data-trigger="focus" data-content="
	...
	<a href='{{ route("owner_excel") }}'>Owners</a>"
