        ...
        <div class="col-lg-12">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    <label class="control-label" style="font-weight: normal;">{{ $device_field->value }}</label>
                        <!-- <input type="text" class="form-control" style="font-size: 12px !important;" id="deviceInformation" name="deviceInformation" value="{{ $device_field->value }}"> -->
                    </div>
                </div>
                @endforeach
            </form>
